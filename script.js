...
const navConfig = {
    ...
    director: [ { id: 'home', icon: 'house', label: 'Início', action: 'loadDashboard()' }, { id: 'management', icon: 'briefcase', label: 'Gestão', action: "switchAdminTab('students')" }, { id: 'grades', icon: 'file-text', label: 'Notas', action: 'loadGrades()' }, { id: 'attendance', icon: 'list-checks', label: 'Chamada', action: 'loadAttendanceInit()' }, { id: 'events', icon: 'calendar', label: 'Eventos', action: 'loadEvents()' }, { id: 'messages', icon: 'chat-circle-text', label: 'Chat', action: 'renderChatContacts()' } ],
    coordinator: [ { id: 'home', icon: 'house', label: 'Início', action: 'loadDashboard()' }, { id: 'management', icon: 'briefcase', label: 'Gestão', action: "switchAdminTab('students')" }, { id: 'grades', icon: 'file-text', label: 'Notas', action: 'loadGrades()' }, { id: 'attendance', icon: 'list-checks', label: 'Chamada', action: 'loadAttendanceInit()' }, { id: 'events', icon: 'calendar', label: 'Eventos', action: 'loadEvents()' }, { id: 'messages', icon: 'chat-circle-text', label: 'Chat', action: 'renderChatContacts()' } ],
    teacher: [ { id: 'grades', icon: 'file-text', label: 'Notas', action: 'loadGrades()' }, { id: 'attendance', icon: 'list-checks', label: 'Chamada', action: 'loadAttendanceInit()' }, { id: 'events', icon: 'calendar', label: 'Eventos', action: 'loadEvents()' }, { id: 'messages', icon: 'chat-circle-text', label: 'Chat', action: 'renderChatContacts()' } ],
    parent: [ { id: 'grades', icon: 'student', label: 'Boletim', action: 'loadGrades()' }, { id: 'attendance', icon: 'list-checks', label: 'Faltas', action: 'loadAttendanceInit()' }, { id: 'events', icon: 'calendar', label: 'Eventos', action: 'loadEvents()' }, { id: 'messages', icon: 'chat-circle-text', label: 'Chat', action: 'renderChatContacts()' } ]
};
...
function buildNav(role) {
    ...
    const desk = document.getElementById('desktopNavItems'); 
    const mob = document.getElementById('mobileBottomNav'); 
...
function switchTab(viewId) {
    ...
    navConfig[currentUser.role].forEach(item => {
        let dBtn = document.getElementById(`deskNav-${item.id}`); 
        let mBtn = document.getElementById(`mobNav-${item.id}`);
        if(dBtn && mBtn) { 
            if(item.id === viewId) { 
